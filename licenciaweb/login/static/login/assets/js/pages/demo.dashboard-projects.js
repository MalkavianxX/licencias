!(function (o) {
  "use strict";
  var test_aproval = parseInt(document.getElementById('chart-aprobados').value);
  var test_failing = parseInt( document.getElementById('chart-reprobados').value);
  var test_incomplete = parseInt( document.getElementById('chart-tiempo-acabado').value);
  function t() {
    ...
    (t.prototype.initCharts = function () {
      ...
      return (
        ...
        0 < o("#project-status-chart").length &&
          ((t = {
            labels: ["Aprobados", "Tiempo agotado", "Reprobados"],
            datasets: [
              {
                data: [test_aproval, test_incomplete, test_failing],
